...
namespace Calculator
{
    public partial class Form2 : Form
    {
        ...
        public event KalkulasiEventHandler nalenKalkulasi;
        ...
        private void btnProses_Click(object sender, EventArgs e)
        {
            ...
            {
                nalenKalkulasi(0, NilaiA, NilaiB);
            }
            else if (cbOperasi.SelectedIndex == 1)
            {
                nalenKalkulasi(1, NilaiA, NilaiB);
            }
             else if (cbOperasi.SelectedIndex == 2)
            {
                nalenKalkulasi(2, NilaiA, NilaiB);
            }
             else 
            {
                nalenKalkulasi(3, NilaiA, NilaiB);
            }
        }
    }
}
